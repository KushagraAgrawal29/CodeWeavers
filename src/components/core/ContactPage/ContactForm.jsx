...
import { ContactUs } from "../../../services/operations/contactService";
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-7">
        <div className="flex flex-col md:flex-row gap-5">
          <label className="w-full">
            ...
            />
            {errors.firstName && (
              <p className="input-error-style">Please enter your first name</p>
            )}
          </label>
          ...
          <label className="w-full">
            ...
            {errors.lastName && (
              <p className="input-error-style">Please enter your last name</p>
            )}
          </label>
        </div>
        ...
        <div>
          ...
          <div className="flex items-center gap-x-4">
            ...
            <div className="w-[calc(100%-90px)]">
              ...
              />
              {errors.phoneNo && (
                <p className="input-error-style">{errors.phoneNo.message}</p>
              )}
            </div>
          </div>
        </div>
        ...
        <div>
          <label>
            ...
            />
            {errors.message && (
              <p className="input-error-style">Please enter your message</p>
            )}
          </label>
        </div>
