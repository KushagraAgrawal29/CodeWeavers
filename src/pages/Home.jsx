  ...
  return (
    <div>
      ...
      <div className="relative mx-auto flex flex-col w-11/12 max-w-maxContent items-center gap-8 text-white justify-between">
        <Link to={"/signup"}>
          <div className="group mx-auto mt-16 rounded-full bg-richblack-800 p-1 font-bold text-richblack-200 drop-shadow-[0_1.5px_rgba(255,255,255,0.25)] transition-all duration-200 hover:scale-95 w-fit hover:drop-shadow-none">
          ...
          <CodeBlocks
            ...
            heading={
              <div className="text-4xl font-semibold">
                Unlock your
                <HighlightText text={"coding potenial"} /> with our online
                courses
              </div>
            }
            subheading={
          ...
          <div className="flex flex-row gap-5 mb-10 mt-[95px]">
            ...
            <div className="flex flex-col gap-10 w-[40%] items-start">
              <div className="text-[16px]">
                The modern CodeWeavers is the dictates its own terms. Today, to
