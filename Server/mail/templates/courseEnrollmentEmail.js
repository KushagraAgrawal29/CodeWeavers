...
<head>
    ...
    <body>
        <div class="conatiner">
            ...
            <div class="body">
                <p>Dear ${name},</p>
                <p>Ypu have successfully registered for the course <span class="highlight">"${courseName}"</span>We are excited to have 
                you as our participant!</p>
                <p>Please login to your learning dashboard to access the course materials and start your learning
                </p>
